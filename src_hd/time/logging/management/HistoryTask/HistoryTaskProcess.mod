...
Hs0 f0 type time.logging.management.HistoryTask.HistoryTaskData #txt
...
Hs0 f1 type time.logging.management.HistoryTask.HistoryTaskData #txt
...
Hs0 f3 type time.logging.management.HistoryTask.HistoryTaskData #txt
Hs0 f3 actionDecl 'time.logging.management.HistoryTask.HistoryTaskData out;
' #txt
...
Hs0 f4 type time.logging.management.HistoryTask.HistoryTaskData #txt
Hs0 f4 guid 177DDA4E16B4EFED #txt
Hs0 f4 211 147 26 26 0 12 #rect
Hs0 f4 @|RichDialogEndIcon #fIcon
Hs0 f5 expr out #txt
Hs0 f5 109 160 211 160 #arcP
>Proto Hs0 .type time.logging.management.HistoryTask.HistoryTaskData #txt
