...
Ws0 WorkItemProcess Big #zClass
Ws0 RD #cInfo
Ws0 #process
...
>Proto Ws0 Ws0 WorkItemProcess #zField
Ws0 f0 guid 177DDB66AE4656BB #txt
Ws0 f0 type time.logging.management.WorkItem.WorkItemData #txt
...
Ws0 f1 type time.logging.management.WorkItem.WorkItemData #txt
...
Ws0 f3 type time.logging.management.WorkItem.WorkItemData #txt
Ws0 f3 actionDecl 'time.logging.management.WorkItem.WorkItemData out;
' #txt
...
Ws0 f4 type time.logging.management.WorkItem.WorkItemData #txt
Ws0 f4 guid 177DDB66AEC9E8A7 #txt
Ws0 f4 211 147 26 26 0 12 #rect
Ws0 f4 @|RichDialogEndIcon #fIcon
Ws0 f5 expr out #txt
Ws0 f5 109 160 211 160 #arcP
>Proto Ws0 .type time.logging.management.WorkItem.WorkItemData #txt
